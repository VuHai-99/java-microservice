...
public class PaymentCancelledKafkaPublisher implements PaymentCancelledMessagePublisher {
    ...
    public PaymentCancelledKafkaPublisher(PaymentMessagingDataMapper paymentMessagingDataMapper, KafkaProducer<String, PaymentResponseAvroModel> kafkaProducer, PaymentServiceConfigData paymentServiceConfigData, KafkaMessageHelper kafkaMessageHelper) {
    ...
    public void publish(PaymentCancelledEvent domainEvent) {
        ...
        try {
            PaymentResponseAvroModel
                    paymentResponseAvroModel = paymentMessagingDataMapper.paymentCancelledEventToPaymentResponseAvroModel(domainEvent);
