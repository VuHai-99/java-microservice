...
public class PaymentFailedKafkaPublisher implements PaymentFailedMessagePublisher {
    ...
    public PaymentFailedKafkaPublisher(PaymentMessagingDataMapper paymentMessagingDataMapper, KafkaProducer<String, PaymentResponseAvroModel> kafkaProducer, PaymentServiceConfigData paymentServiceConfigData, KafkaMessageHelper kafkaMessageHelper) {
    ...
    public void publish(PaymentFailedEvent domainEvent) {
        ...
        try {
            PaymentResponseAvroModel
                    paymentResponseAvroModel = paymentMessagingDataMapper.paymentFailedEventToPaymentResponseAvroModel(domainEvent);
