...
@Slf4j
@Component
public class CreateOrderKafkaMessagePublisher implements OrderCreatedPaymentReequestMessagePublisher {
    ...
    public void publish(OrderCreatedEvent domainEvent) {
        ...
        try {
            ...
            kafkaProducer.send(
                    orderServiceConfigData.getPaymentRequestTopicName(), orderId, paymentRequestAvroModel, orderKafkaMessageHelper.getKafkaCallback(
